...
function pieChart() {
	...
	if ((jQuery().easyPieChart) && (jQuery.support.leadingWhitespace)) {
		var count = 0 ;
		var colors = ['darkorange', '#5FCCA3', '#FFBB19'];
	...
	if (jQuery().jflickrfeed) {
		jQuery("#flickr").jflickrfeed({
			...
			jQuery("#flickr a").prettyPhoto({
			   ...
			   jQuery(this).find("img").stop().animate({ opacity: 0.9 }, 800);
		    }, function() {
			   jQuery(this).find("img").stop().animate({ opacity: 1.0 }, 1200);
		    });
		});
	}
...
var flickrApiKey = '2bedbe1a4435df24ecf907413642eaaa0'; 
var flickrApiSecret = '720c45b877f262fa';
var flickrUserId = '197129023@N04'